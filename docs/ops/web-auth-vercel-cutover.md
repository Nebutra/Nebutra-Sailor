...
> **Note (2026-09-07):** the per-app `deploy-*-vercel.yml` workflows named below were folded into the single parameterized `.github/workflows/deploy-vercel.yml` (#482); DNS one-shots into `point-dns.yml` (#479). Read the workflow names here as the app selector of those two workflows.
