...
const messages = [
  { user: "SK", name: "Sarah K.", time: "2:14 PM", text: "Just deployed the new RAG pipeline — latency dropped 40%" },
  { user: "MR", name: "Marco R.", time: "2:16 PM", text: "Nice! What embedding model are you using?" },
  { user: "SK", name: "Sarah K.", time: "2:17 PM", text: "Cohere v3 with HNSW index. Happy to share the config." },
  { user: "JL", name: "Jun L.", time: "2:19 PM", text: "Would love to see that. We're still on ada-002." },
];
      ...
      >
        ...
        <div className="flex flex-1 min-h-0">
          ...
          <div className="w-36 border-r border-border p-2 shrink-0 space-y-0.5">
            <div className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider px-2 py-1">Channels</div>
            {channels.map((c, i) => (
            ...
            <div className="flex-1 p-3 space-y-3 overflow-hidden">
              {messages.map((m) => (
                <div key={m.time} className="flex gap-2">
                  <div className="h-6 w-6 rounded-full bg-muted flex items-center justify-center shrink-0 text-[9px] font-bold text-muted-foreground">{m.user}</div>
          ...
          <div className="w-32 border-l border-border p-2 shrink-0">
            <div className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider px-1 py-1">Online — 5</div>
