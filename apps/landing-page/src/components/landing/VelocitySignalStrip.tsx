            ...
            >
              ...
              <div className="flex flex-col items-start text-left">
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  ...
                  <ArrowRight className="h-3.5 w-3.5 text-primary opacity-0 -ml-2 group-hover:opacity-100 group-hover:ml-0 transition-[margin,opacity] duration-300 motion-reduce:ml-0" />
                </div>
              </div>
            </Link>
          </AnimateIn>
