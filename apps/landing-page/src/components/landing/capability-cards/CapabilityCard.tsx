    ...
    >
      <div className="flex h-full flex-col gap-8">
        <Link href={ctaHref} className="mt-8 flex items-center gap-3 w-fit group/link">
          <div className="size-8 rounded-full border border-border/50 dark:border-white/10 flex items-center justify-center text-muted-foreground group-hover/link:text-foreground group-hover/link:border-foreground dark:group-hover/link:text-white dark:group-hover/link:border-white transition-colors cursor-pointer bg-background/50 backdrop-blur-sm">
