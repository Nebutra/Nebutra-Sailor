  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 items-stretch gap-2">
        {/* Container card */}
        <div className="flex flex-1 flex-col gap-1.5 rounded-[var(--radius-md)] border border-[var(--neutral-6)] bg-[var(--neutral-1)] p-2">
        ...
        <div className="flex w-[100px] shrink-0 flex-col gap-1.5">
          ...
          {/* Live cell */}
          <div className="flex flex-1 flex-col justify-center gap-0.5 rounded-[var(--radius-md)] border border-[var(--neutral-6)] bg-[var(--neutral-1)] p-1.5">
