    ...
    >
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex min-w-0 flex-1 items-center justify-between gap-2">
          <span className="truncate text-[12px] font-semibold text-[var(--neutral-12)]">
            {copy.campaign}
          </span>
      ...
      <div className="grid grid-cols-3 gap-1.5">
        <div className="flex flex-col gap-0.5 rounded-md bg-[var(--neutral-1)] px-2 py-1.5 ring-1 ring-[var(--neutral-6)]">
          ...
          <span className="font-mono text-[12px] font-semibold text-[var(--neutral-12)]">
            12,400
          </span>
        </div>
        <div className="flex flex-col gap-0.5 rounded-md bg-[var(--neutral-1)] px-2 py-1.5 ring-1 ring-[var(--neutral-6)]">
        ...
        <div className="flex flex-col gap-0.5 rounded-md bg-[var(--neutral-1)] px-2 py-1.5 ring-1 ring-[var(--neutral-6)]">
          ...
          <span className="font-mono text-[12px] font-semibold text-[var(--neutral-12)]">12%</span>
        </div>
      </div>
      ...
      <div className="space-y-1">
        ...
        <p className="truncate font-mono text-[10px] text-[var(--neutral-10)]">{copy.footer}</p>
      </div>
    </div>
  );
}
