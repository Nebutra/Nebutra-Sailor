...
const CAPTION_SEGMENTS: ReadonlyArray<Segment> = [
  { width: 22, bg: "var(--neutral-7)" },
  { width: 28, bg: "var(--neutral-7)" },
  { width: 18, bg: "var(--neutral-7)" },
  { width: 32, bg: "var(--neutral-7)" },
];
...
export function VideoComposeGlyph(_props: SubpackageGlyphProps) {
  return (
    ...
    >
      ...
      {/* Playhead line */}
      <div className="relative h-px w-full bg-[var(--neutral-6)]">
        <span
          aria-hidden="true"
          className="absolute top-1/2 h-2 w-px -translate-y-1/2 bg-[var(--blue-9)]"
          style={{ left: "38%" }}
        />
      </div>
      ...
      <div className="flex items-center justify-between">
        <span className="font-mono text-[11px] text-[var(--neutral-11)]">0:08 / 0:42</span>
