  ...
  return (
    <div aria-hidden className="flex w-full flex-col justify-center" style={{ height: 160 }}>
      <div className="mx-auto flex w-full max-w-[300px] flex-col gap-2 rounded-lg bg-[var(--neutral-1)] p-3 ring-1 ring-[var(--neutral-6)] shadow-sm">
        {/* Code line */}
        <div className="rounded-md bg-[var(--neutral-2)] px-2 py-1.5 ring-1 ring-[var(--neutral-5)]">
        ...
        <div className="flex flex-col gap-1">
          {ROWS.map((row) => {
            ...
            return (
              <div
                key={row.id}
                className="flex items-center gap-2 rounded-md bg-[var(--neutral-2)] px-2 py-1 ring-1 ring-[var(--neutral-5)]"
              >
                {blocked ? (
