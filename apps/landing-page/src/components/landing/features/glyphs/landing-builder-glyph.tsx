...
export function LandingBuilderGlyph({ locale }: SubpackageGlyphProps) {
  ...
  return (
    <div
      aria-hidden="true"
      className="flex w-full items-stretch gap-2.5 rounded-lg bg-[var(--neutral-2)] px-3 py-3"
      style={{ height: 160 }}
    >
      {/* Left: browser-frame mockup */}
      <div className="flex w-[44%] shrink-0 flex-col overflow-hidden rounded-md bg-[var(--neutral-1)] ring-1 ring-[var(--neutral-6)]">
        {/* Browser chrome */}
        <div className="flex items-center gap-1 border-b border-[var(--neutral-6)] bg-[var(--neutral-2)] px-1.5 py-1">
          ...
          <span className="h-1.5 w-1.5 rounded-full bg-[var(--neutral-7)]" />
          <span className="h-1.5 w-1.5 rounded-full bg-[var(--neutral-7)]" />
          <div className="ml-1 flex min-w-0 flex-1 items-center gap-1 rounded-sm bg-[var(--neutral-1)] px-1 py-[1px]">
        ...
        <div className="flex flex-1 flex-col gap-1.5 p-1.5">
          {/* Hero */}
          <div className="space-y-1 rounded-sm bg-[var(--neutral-2)] p-1.5">
            <div className="h-1.5 w-2/3 rounded-sm bg-[var(--neutral-7)]" />
            <div className="h-1 w-full rounded-sm bg-[var(--neutral-5)]" />
            <div className="h-1.5 w-7 rounded-sm bg-[var(--brand-primary)]" />
          </div>
          {/* Features grid */}
          <div className="grid grid-cols-3 gap-1">
            <div className="h-5 rounded-sm bg-[var(--neutral-3)] ring-1 ring-[var(--neutral-6)]" />
            <div className="h-5 rounded-sm bg-[var(--neutral-3)] ring-1 ring-[var(--neutral-6)]" />
            <div className="h-5 rounded-sm bg-[var(--neutral-3)] ring-1 ring-[var(--neutral-6)]" />
          </div>
          {/* Pricing */}
          <div className="flex items-center gap-1">
            <div className="h-3 flex-1 rounded-sm bg-[var(--neutral-3)] ring-1 ring-[var(--neutral-6)]" />
            <div className="h-3 flex-1 rounded-sm bg-[var(--neutral-3)] ring-1 ring-[var(--neutral-6)]" />
          </div>
        </div>
      </div>
      ...
      <div className="flex min-w-0 flex-1 flex-col justify-between gap-1.5">
        ...
        <div className="flex flex-1 flex-col justify-center gap-1">
          {copy.prompts.map((prompt) => (
            <div
              key={prompt}
              className="flex items-center gap-1 rounded-md bg-[var(--neutral-1)] px-1.5 py-1 ring-1 ring-[var(--neutral-6)]"
            >
