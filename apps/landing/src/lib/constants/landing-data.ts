...
const packageIcon = (className = "h-4 w-4") => React.createElement(Package, { className });
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: React.createElement(FileCode2, { className: "h-4 w-4" }),
      },
      {
        id: "backends-python",
        label: "python",
    ...
    children: [
      {
        ...
        icon: React.createElement(FileTerminal, { className: "h-4 w-4" }),
      },
      {
        id: "workspace",
        ...
        icon: React.createElement(FileJson, { className: "h-4 w-4" }),
      },
      {
        id: "turbo",
        label: "turbo.json",
