...
export function ProductDemoSection() {
  ...
  // Keep this a small literal union: Parameters<typeof t>[0] over the typed
  // message tree is too complex for tsc to represent (TS2590).
  type ProductDemoTranslationKey = `${ProductDemoTabId}.label` | `${ProductDemoTabId}.desc`;
