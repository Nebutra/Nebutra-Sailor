...
export function HeroLottieVisual() {
  return (
    <div className="relative mx-auto flex w-full max-w-md items-center justify-center rounded-[var(--radius-card)] border border-(--blue-7)/40 bg-(--neutral-1)/70 p-6 shadow-brand-lg">
      <div
