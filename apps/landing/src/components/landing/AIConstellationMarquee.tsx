...
function IconChip({ icon, name }: AiIcon) {
  ...
  return (
    <div
      ...
      className="flex items-center gap-2.5 px-4 py-2.5 rounded-full border border-border bg-background/80 hover:bg-muted hover:-translate-y-px transition-[background-color,border-color,transform] duration-150 motion-reduce:hover:translate-y-0 group select-none"
    >
