...
export const CAPABILITY_FOLDERS: CapabilityFolder[] = [
  ...
  },
  {
    ...
    signature: {
      ...
      detail: copy(
        "166 runtime source files spanning db, gateway-core, provider-factory, tenant-store, trace-store, config, errors, and observability.",
        "166 个运行时源码文件覆盖 db、gateway-core、provider-factory、tenant-store、trace-store、config、errors 与可观测性。",
      ),
    },
    topology: {
