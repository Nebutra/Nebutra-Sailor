  ...
  return (
    <div
      className={cn(
        ...
        active
          ? "border-transparent bg-primary text-primary-foreground shadow-[0_10px_30px_-18px_hsl(var(--primary))]"
        ...
        <div className="relative flex flex-col gap-5 p-4 md:p-5">
          <div className="flex flex-col gap-3 border-border/60 border-b pb-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex min-w-0 items-center gap-2">
              <span className="inline-flex size-7 items-center justify-center rounded-[var(--radius-sm)] bg-primary text-primary-foreground">
