      ...
      <div className="container relative z-10 mx-auto px-4 max-w-[1400px]">
        ...
        >
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 relative z-20">
            ...
            <div className="relative order-1 flex w-full flex-col gap-3 lg:order-1 lg:w-4/12">
              <SlidingIndicator
                activeKey={activeTab}
                className="rounded-[var(--radius-card)] bg-primary/5"
              />
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative z-10 flex-1 pt-1">
                      ...
                      {/* grid-template-rows 0fr→1fr is the one way CSS can
                            animate to auto height, so the accordion needs no
            ...
            <div className="hidden w-full lg:w-8/12 relative lg:order-2 lg:block">
              ...
              >
                ...
                <AnimateIn
                  ...
                  duration={0.5}
                  from={{ scale: 0.95, filter: "blur(10px)" }}
                  key={activeTab}
                  preset="fade"
                >
