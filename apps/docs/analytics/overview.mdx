...
No complex SDK configuration is required. Nebutra reads two environment variables for PostHog and one for Dub.co:
...
- **Cloud (EU)**: Use `https://eu.posthog.com` as `NEXT_PUBLIC_POSTHOG_HOST` to keep data in the EU.
- **Self-hosted**: Deploy PostHog on your own infrastructure. Set `NEXT_PUBLIC_POSTHOG_HOST` to your instance URL.
...
<CardGroup cols={2}>
  ...
  <Card title="Admin Panel" icon="gauge" href="/guides/admin-panel">
