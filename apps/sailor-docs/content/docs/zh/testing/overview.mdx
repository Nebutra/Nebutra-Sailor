...
<CardGroup cols={2}>
  <Card title="Vitest 配置" icon="flask" href="/zh/testing/overview">
    Vitest 配置、测试工具函数和数据库固定数据设置。
  </Card>
  <Card title="Playwright 端到端测试" icon="browser" href="/zh/testing/overview">
    Playwright 配置、页面对象模型和 CI 配置。
  </Card>
  <Card title="CI / CD" icon="arrows-rotate" href="/zh/deployment/overview">
