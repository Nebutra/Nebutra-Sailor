...
To change the font family, update the `next/font` configuration in `apps/web/src/app/layout.tsx` and `apps/landing-page/src/app/layout.tsx`, then update the CSS variable fallbacks in `packages/design/tokens/styles.css`.
