...
<CardGroup cols={2}>
  <Card title="Vitest Configuration" icon="flask" href="/development/testing">
    Vitest config, test utilities, and database fixture setup.
  </Card>
  <Card title="Playwright E2E" icon="browser" href="/development/e2e">
    Playwright setup, page object models, and CI configuration.
  </Card>
  <Card title="CI / CD" icon="arrows-rotate" href="/deployment/ci">
