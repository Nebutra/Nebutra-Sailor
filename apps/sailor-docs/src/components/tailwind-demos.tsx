  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          type="button"
          className={`group relative flex h-24 w-full flex-col items-start justify-between p-3 text-left transition-transform hover:z-10 focus:z-10 hover:scale-105 motion-reduce:hover:scale-100 rounded-md mx-0.5 ${className} ${contrastClass}`}
