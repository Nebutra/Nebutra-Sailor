  ...
  return (
    <article className={`${TL_CONTAINER} py-12 md:py-20`}>
      <div data-tl-section className="mx-auto max-w-[42rem] will-change-transform">
        ...
        <h1 className="tl-display text-[clamp(2.75rem,6vw,4.25rem)]">About TypeLens</h1>
        <div className="mt-10 space-y-6 text-[1.125rem] leading-[1.7] text-[var(--tl-ink-soft)] md:text-[1.2rem]">
          <p>
            <strong className="font-semibold text-[var(--tl-ink)]">TypeLens</strong> is an AI-native
            library of real-world typography: verified pairings, hierarchies, and systems — for
            human designers and design agents.
          </p>
          <p>
