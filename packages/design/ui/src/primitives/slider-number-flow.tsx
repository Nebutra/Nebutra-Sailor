...
export const SliderNumberFlow = ({
  ...
  >
    ...
    <BaseSlider.Thumb
      className="relative block h-5 w-5 rounded-full border border-border bg-background shadow-[var(--elevation-control)] ring-1 ring-border/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
